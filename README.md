...
- if an UI5 object can be matched with the search input, it will be displayed immediately,
- otherwise the hitlist is shown
...
- displaying specific members: ?p will display only properties, ?c - constructor, ?e - events, ?m - methods;
  ![basic search](https://publicrepo.vipserv.org/images/vscode-api/search-members1.gif)

- members can be also filtered by a search term, for example to display only methods with "add",
- type "hbox ?madd"
  ![basic search](https://publicrepo.vipserv.org/images/vscode-api/search-members2.gif)
