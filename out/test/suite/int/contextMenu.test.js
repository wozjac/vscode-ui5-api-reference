...
describe("Context Menu tests", () => {
    ...
    it("Should find sap.ui.core.Title #1", async () => {
        const document = await vscode.workspace.openTextDocument(path.resolve(__dirname, "../../support/editor/view1.xml"));
        ...
        (0, chai_1.expect)(out).to.deep.equal("sap.ui.core.Title");
    });
    it("Should find sap.ui.core.Title #2", async () => {
        const document = await vscode.workspace.openTextDocument(path.resolve(__dirname, "../../support/editor/view2.xml"));
        await vscode.window.showTextDocument(document);
        const editor = vscode.window.activeTextEditor;
        const position = editor.selection.active;
    ...
    it("Should find sap.ui.core.Title #4", async () => {
        const document = await vscode.workspace.openTextDocument(path.resolve(__dirname, "../../support/editor/view3.xml"));
        await vscode.window.showTextDocument(document);
        const editor = vscode.window.activeTextEditor;
        const position = editor.selection.active;
    ...
    it("Should find sap.m.Page #1", async () => {
        ...
        editor.selection = newSelection;
        const out = contextMenu.findControl(editor);
        (0, chai_1.expect)(out).to.deep.equal("sap.m.Page");
    });
    ...
    it("Should find sap.m.App #1", async () => {
        ...
        editor.selection = newSelection;
        const out = contextMenu.findControl(editor);
        (0, chai_1.expect)(out).to.equal("sap.m.App");
    });
    it("Should find sap.m.App #2", async () => {
        ...
        editor.selection = newSelection;
        const out = contextMenu.findControl(editor);
        (0, chai_1.expect)(out).to.deep.equal("sap.m.App");
    });
    ...
    it("Should find sap.m.Text #1", async () => {
        ...
        editor.selection = newSelection;
        const out = contextMenu.findControl(editor);
        (0, chai_1.expect)(out).to.deep.equal("sap.m.Text");
    });
