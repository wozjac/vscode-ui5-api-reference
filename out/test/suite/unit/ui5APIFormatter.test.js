...
describe("ui5APIFormatter tests", () => {
    ...
    it("Should format JS doc with html and corrected headers", () => {
        expect(ui5APIFormatter.formatJsDoc("This <h1>is</h1> object{@jsdoc} <p class='css'>with</p> #member " + "<h5>member</h5>.")).to.equal("This <h5>is</h5> object with <h5>member</h5>.");
    });
    it("Should format JS doc without any html except headers", () => {
        expect(ui5APIFormatter.formatJsDoc("This <h1>is</h1> object{@jsdoc} <p class='css'>with</p> #member " + "<h5>member</h5>.", true)).to.equal("This is object with member.");
    });
});
//# sourceMappingURL=ui5APIFormatter.test.js.map