...
class APIReferenceCtrl {
    ...
    getDesignAPI(ui5ObjectPath) {
        ...
        if (this._searchState.memberSearchString || this._searchState.memberGroupFilter) {
            designApi = ui5APIFormatter.filterApiMembers(designApi, this._searchState.memberSearchString, this._searchState.memberGroupFilter);
        }
...
//# sourceMappingURL=APIReferenceCtrl.js.map