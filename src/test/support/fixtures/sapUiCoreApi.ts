      ...
      methods: [
        {
          ...
          parameters: [
            ...
            },
            {
              ...
              optional: true,
              description:
                "Context object to call the event handler with. Defaults to this <code>sap.m.Tree</code> itself",
            },
          ],
          description:
      ...
      methods: [
        {
          ...
          parameters: [
            ...
            },
            {
              ...
              optional: true,
              description:
                "The object that wants to be notified when the event occurs (<code>this</code> context within the handler function). If it is not specified, the handler function is called in the context of the event provider.",
            },
          ],
        ...
        },
        {
          ...
          returnValue: {
            ...
            description:
              "Returns <code>this</code> to allow method chaining. When <code>preventDefault</code> is supported on the fired event the function returns <code>true</code> if the default action should be executed, <code>false</code> otherwise.",
          },
          parameters: [
            {
              name: "sEventId",
            ...
            },
            {
              ...
              optional: true,
              description:
                "Defines whether function <code>preventDefault</code> is supported on the fired event",
            },
            {
              ...
              optional: true,
              description:
                "Defines whether event bubbling is enabled on the fired event. Set to <code>true</code> the event is also forwarded to the parent(s) of the event provider ({@link #getEventingParent}) until the bubbling of the event is stopped or no parent is available anymore.",
            },
          ],
          description:
